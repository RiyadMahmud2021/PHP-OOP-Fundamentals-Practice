...
<?php
    final class UserData{   // Its a super class/ parent class   // UserData is the class name   
        ...
        public final function display(){ // parent class a display and child class a display
